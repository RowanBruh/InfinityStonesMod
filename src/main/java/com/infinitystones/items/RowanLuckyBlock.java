...
/**
 * Special Lucky Block for Rowan Industries
 */
public class RowanLuckyBlock extends Block {
    ...
    private void triggerLuckyEffect(World world, BlockPos pos, PlayerEntity player) {
        ...
        switch (effect) {
            ...
            case 3:
                ...
                player.sendMessage(
                        new StringTextComponent("The Rowan Lucky Block granted you special powers!").mergeStyle(TextFormatting.GREEN),
                        player.getUniqueID());
                break;
            case 4:
                // Spawn hostile mobs
                ...
                player.sendMessage(
                        new StringTextComponent("Uh oh! The Rowan Lucky Block was cursed!").mergeStyle(TextFormatting.RED),
                        player.getUniqueID());
                break;
            case 5:
                // Spawn creeper trap
            ...
            case 6:
                ...
                player.sendMessage(
                        new StringTextComponent("The Rowan Lucky Block drops valuable materials!").mergeStyle(TextFormatting.AQUA),
                        player.getUniqueID());
                break;
            case 7:
                ...
                player.sendMessage(
                        new StringTextComponent("Rowan Industries mystery boxes appear!").mergeStyle(TextFormatting.WHITE),
                        player.getUniqueID());
                break;
            case 8:
                ...
                player.sendMessage(
                        new StringTextComponent("A special Rowan box materializes!").mergeStyle(TextFormatting.BLUE),
                        player.getUniqueID());
                break;
            case 9:
                ...
                for (int i = 0; i < 16; i++) {
                    ...
                    if (!world.getBlockState(new BlockPos(x, y, z)).getMaterial().blocksMovement() &&
                        ...
                        player.sendMessage(
                                new StringTextComponent("The Rowan Lucky Block teleported you to a random location!").mergeStyle(TextFormatting.LIGHT_PURPLE),
                                player.getUniqueID());
                        break;
                    }
                }
            ...
            case 10:
                ...
                player.sendMessage(
                        new StringTextComponent("JACKPOT! You found a Rowan Legendary Box!").mergeStyle(TextFormatting.GOLD, TextFormatting.BOLD),
                        player.getUniqueID());
                break;
            case 11:
                ...
                player.sendMessage(
                        new StringTextComponent("The Rowan Lucky Block grants you a special tool!").mergeStyle(TextFormatting.AQUA),
                        player.getUniqueID());
                break;
            case 12:
                ...
                player.sendMessage(
                        new StringTextComponent("The Rowan Lucky Block grants you a powerful weapon!").mergeStyle(TextFormatting.DARK_PURPLE),
                        player.getUniqueID());
                break;
            case 13:
                ...
                player.sendMessage(
                        new StringTextComponent("Rowan's power to control lightning is now yours!").mergeStyle(TextFormatting.YELLOW),
                        player.getUniqueID());
                break;
            case 14:
                // More lucky blocks!
                for (int i = 0; i < 3; i++) {
                    dropItem(world, pos, new ItemStack(ModItems.ROWAN_LUCKY_BLOCK_ITEM.get(), 1));
                }
                player.sendMessage(
                        new StringTextComponent("More Rowan Lucky Blocks appear!").mergeStyle(TextFormatting.GREEN),
                        player.getUniqueID());
                break;
            case 15:
                ...
                player.sendMessage(
                        new StringTextComponent("BOOM! The Rowan Lucky Block was trapped!").mergeStyle(TextFormatting.RED),
                        player.getUniqueID());
                break;
            case 16:
                // Insane Craft weapon
                ...
                if (weaponStack != null) {
                    ...
                    player.sendMessage(
                            new StringTextComponent("A Rowan Industries weapon appears!").mergeStyle(TextFormatting.GOLD),
                            player.getUniqueID());
                }
                break;
            case 17:
                ...
                if (armorStack != null) {
                    ...
                    player.sendMessage(
                            new StringTextComponent("A piece of Rowan Industries Armor materializes!").mergeStyle(TextFormatting.DARK_PURPLE),
                            player.getUniqueID());
                }
                break;
            case 18:
                ...
                serverWorld.spawnParticle(
                        ...
                        50, 1.0, 1.0, 1.0, 0.5);
                player.sendMessage(
                        new StringTextComponent("Rowan's knowledge flows into your mind!").mergeStyle(TextFormatting.GREEN),
                        player.getUniqueID());
                break;
            case 19:
                ...
                serverWorld.spawnParticle(
                        ...
                        1, 0, 0, 0, 0);
                player.sendMessage(
                        new StringTextComponent("INCREDIBLE! Rowan grants you the Infinity Gauntlet!").mergeStyle(TextFormatting.GOLD, TextFormatting.BOLD),
                        player.getUniqueID());
                break;
            case 20:
                ...
                player.sendMessage(
                        new StringTextComponent("ROWAN'S COSMIC POWER! A Cosmic Box appears!").mergeStyle(TextFormatting.AQUA, TextFormatting.BOLD),
                        player.getUniqueID());
                break;
        }
    }
     ...
     */
    public static class RowanLuckyBlockItem extends BlockItem {
        public RowanLuckyBlockItem(Block block) {
        ...
        public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
            tooltip.add(new StringTextComponent("Rowan Industries Lucky Block").mergeStyle(TextFormatting.GOLD));
