...
public class BionicBaseStructure extends Structure<NoFeatureConfig> {
    
    // Structure resource location
    private static final ResourceLocation STRUCTURE_ID = 
            new ResourceLocation(InfinityStonesMod.MOD_ID, "bionic_base");

    public BionicBaseStructure(Codec<NoFeatureConfig> codec) {
        super(codec);
    }
    ...
    public IStartFactory<NoFeatureConfig> getStartFactory() {
        return BionicBaseStructure.Start::new;
    }
    ...
    protected boolean func_230363_a_(ChunkGenerator chunkGenerator, 
        ...
        // Allow spawning in any overworld biome that's not ocean
        return !biome.getCategory().equals(Biome.Category.OCEAN) && 
        ...
        public void func_230364_a_(DynamicRegistries registries, 
            ...
            JigsawManager.func_242837_a(
                    ...
                    new VillageConfig(() -> registries.getRegistry(Registry.JIGSAW_POOL_KEY)
                            .getOrDefault(new ResourceLocation(InfinityStonesMod.MOD_ID, "bionic_base/start_pool")),
